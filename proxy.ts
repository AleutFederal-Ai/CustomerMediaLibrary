...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    "img-src 'self' blob: data: https://*.blob.core.usgovcloudapi.net https://img.youtube.com",
    "media-src 'self' blob: https://*.blob.core.usgovcloudapi.net",
    "connect-src 'self'",
    "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://player.vimeo.com https://www.dailymotion.com https://rumble.com",
