export default function CuiBanner() {
  return (
    <div
      ...
      data-cui-banner="true"
      className="relative z-40 border-b border-[rgba(241,197,108,0.22)] bg-[linear-gradient(90deg,rgba(91,62,11,0.96),rgba(140,101,20,0.92),rgba(91,62,11,0.96))] px-4 py-2.5 text-center text-[0.76rem] font-semibold uppercase tracking-[0.18em] text-[#fff2c5]"
    >
